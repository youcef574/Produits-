...
const translations = {
    ...
    ar: {
        ...
        logout: "تسجيل الخروج",
        my_products: "منتجاتي",
        manage_products: "إدارة جميع منتجاتك من هذه الصفحة",
        ...
        delete_confirmation: "هل أنت متأكد من حذف هذا المنتج؟ هذا الإجراء لا يمكن التراجع عنه.",
        cancel: "إلغاء",
        link_copied: "تم نسخ الرابط!",
        product_activated: "تم تفعيل المنتج",
        product_deactivated: "تم إلغاء تفعيل المنتج",
        product_refreshed: "تم تحديث المنتج",
